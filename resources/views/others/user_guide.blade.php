  ...
  <div class="w-full bg-f8 dark:bg-dark p-8">
    <div class="max-w-6xl mx-auto">
      <a href="{{ route('others.about.comiee') }}"
        ...
        <h3 class="tracking-widest text-[16px] font-bold">{{ __('Comieeについて') }}</h3>
      ...
      <div class="flex flex-col md:flex-row items-center my-8">
        <a href="{{ route('others.faq', ['number' => 1]) }}"
          ...
          <h3 class="tracking-widest text-[16px] font-bold">{{ __('よくあるご質問') }}</h3>
        ...
        <a href="mailto:support@comiee.one?subject={{ __('お問い合わせ') }}" target="_blank" rel="noopener"
          ...
          <h3 class="tracking-widest text-[16px] font-bold">{{ __('お問い合わせ') }}</h3>
