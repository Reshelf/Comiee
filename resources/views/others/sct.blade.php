...
@section('content')
  ...
  <div class="max-w-4xl m-8 md:my-16 md:mx-auto leading-8">
    <h2 class="text-3xl font-bold mb-16">{{ __('「特定商取引に関する法律」及び「資金決済に関する法律」に基づく表示') }}</h2>

    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('事業者名及び連絡先') }}</h3>
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('販売価格') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('支払い方法') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('提供時期') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
        {{ __('決済完了後、直ちに提供いたします。') }}
      </p>
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('作品購入以外でお客様に発生する料金') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('返品について') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
        {{ __('商品の性質上、返品はできかねます。') }}
      </p>
    ...
    <h3 class="text-2xl font-bold mt-12 mb-4">{{ __('動作環境') }}</h3>
    <div class="mb-10 mt-4 text-[15px]">
      <p class="my-2">
        {{ __('ヘルプをご覧ください。') }}
      </p>
