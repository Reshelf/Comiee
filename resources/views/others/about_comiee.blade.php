...
@php
  ...
  $content = __('Comiee（コミー）は、オンラインマンガプラットフォームで、クリエイターが自分の作品を投稿し、読者が楽しみながらサポートできる環境を提供しています。著作権保護や作品の細かい設定、多言語対応など、クリエイターと読者にとって使いやすい機能が揃っています。私たちのミッションは、「クリエイターが安心して作品を投稿し続けられるプラットフォームを提供することで、たくさんの素晴らしい作品が生まれるお手伝いをする」ことです。この目標に向かって、クリエイターの資産を守り最大化すること、より良い作品が生まれるような使いやすいプラットフォームをデザインすること、先見性を持って高い付加価値サービスを追求しマンガ業界に貢献することを大切にしています。');
@endphp
