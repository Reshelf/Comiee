    ...
    <div class="w-full md:w-[70%] p-8 md:py-8 md:pl-20 md:pr-48">
      ...
      <div id="important" class="my-12 leading-8 text-base whitespace-pre-line">
        ...
        <div class="">
          ...
          <p class="mb-4">
            {{ __('名文や超大作を仕上げようとして手が止まってしまうくらいなら、駄文でも短文でも悪ふざけでも、とにかく気軽に投稿しましょう。') }}
          </p>
          <p class="mb-4">
            {{ __('短い文章、下手な文章、ラクガキ...、そういったものを恐れて手をとめる必要はありません。まずは、創作したいこと・伝えたいことを世に送り出す。表現力もファンも、あとから十分ついてきます。') }}
          </p>
          <p class="mb-4">
            {{ __('創作活動は、筋トレやランニングと同じです。一時期に集中して取り組んだら、それで終わりではありません。ちょっとずつで良いので日常生活の一部にすること、クセをつけることがポイントです。') }}
          </p>
          <p class="mb-4">
            <span class="font-bold"> {{ __('創作活動でもっとも大事なこと。それは「創作を楽しみ続ける」「ずっと発表し続ける」こと。') }}</span>
            {{ __('この2つを、頭のかたすみに置いておいてください。') }}
          </p>
          <p class="mb-4">
            {{ __('創作を楽しみ続けるために、発信のときにほんの少し、意識してもらうとよいことをまとめました。') }}
          </p>
          <p class="mb-4">
      ...
      <div id="important" class="my-12 leading-8 text-base whitespace-pre-line">
        ...
        <div class="">
          <p class="mb-4">
            {{ __('Comieeはニューヨークのような「街」を目指しています。そこは、ウォールストリートのような金融街、高級住宅街、中華街から劇場、自然あふれる大きな公園まで、あらゆる文化圏のひとたちが共生している場所。') }}
          </p>
          <p class="mb-4">
            {{ __('とても一般的でプレーンなサービス名には、だれもがどんなことでも書けるように。それぞれの価値観や生活スタイルの違いを楽しみ、隣のコミュニティを揶揄することなく、共存していける空間づくりをしています。') }}
          </p>
          <p class="mb-4">
            {{ __('クリエイターに直接、書籍化のお声がかかることもありますし、Comieeも後押しできるようにサポートをしています。たとえば、メディアとパートナーシップを結んで、定期的におすすめの作品をご紹介して、活躍の場を広げる「クリエイター支援プログラム」をおこなっています。') }}
          </p>
          <p class="mb-4">
            {{ __('さあ、ここまで読んでいただいたあなたは、もうComieeの街の住民です。早速Comieeを使って、あたらしい交流のかたちを楽しみながら、いっしょに、創作の輪を広げていきましょう！') }}
          </p>
        </div>
      </div>
