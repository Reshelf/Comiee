...
@section('content')
    ...
    <div class="w-full flex">
        ...
        <div class="w-[70%] pl-20 pr-48">
            ...
            <div class="my-16">
                <h3 id="1" class="text-2xl font-semibold tracking-widest">Starbooksってどんなアプリ？</h3>
                <p class="mt-4 leading-8">
                    Starbooksは、誰もがマンガを投稿でき、マンガを楽しむことのできるプラットフォームです。<br>
