...
@section('content')
  ...
  <div class="flex w-full mx-auto justify-center">
    <div class="w-full h-screen flex flex-col">
      ...
      <div class="flex-grow flex">
        ...
        <nav class="bg-f8 p-8 w-1/5 min-h-full">
          <ul>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
                <path d="M5 10H7C9 10 10 9 10 7V5C10 3 9 2 7 2H5C3 2 2 3 2 5V7C2 9 3 10 5 10Z" stroke="currentColor"
              ...
              <a href="#" class="text-gray-700 font-semibold">{{ __('ダッシュボード') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
                <path
                  d="M11.7405 17.75H17.6605C17.5705 17.83 17.4805 17.9 17.3905 17.98L13.1205 21.18C11.7105 22.23 9.41049 22.23 7.99049 21.18L3.71049 17.98C2.77049 17.28 2.00049 15.73 2.00049 14.56V7.14998C2.00049 5.92998 2.9305 4.57998 4.0705 4.14998L9.05049 2.27999C9.87049 1.96999 11.2305 1.96999 12.0505 2.27999L17.0205 4.14998C17.9705 4.50998 18.7805 5.50999 19.0305 6.52999H11.7305C11.5105 6.52999 11.3105 6.54 11.1205 6.54C9.27048 6.65 8.79048 7.31998 8.79048 9.42998V14.86C8.80048 17.16 9.39049 17.75 11.7405 17.75Z"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M8.80029 11.22H22.0003" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
                  stroke-linecap="round" stroke-linejoin="round" />
                <path
                  d="M22.0003 9.42001V14.97C21.9803 17.19 21.3703 17.74 19.0603 17.74H11.7403C9.3903 17.74 8.80029 17.15 8.80029 14.84V9.41C8.80029 7.31 9.28029 6.63999 11.1303 6.51999C11.3203 6.51999 11.5203 6.51001 11.7403 6.51001H19.0603C21.4103 6.52001 22.0003 7.10001 22.0003 9.42001Z"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M11.3203 15.26H12.6503" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
                  stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14.7505 15.26H18.0205" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
                  stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <a href="#" class="text-gray-700 font-semibold">{{ __('収益') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
              ...
              <a href="#" class="text-gray-700 font-semibold">{{ __('コンテンツ分析') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
              ...
              <a href="#" class="text-gray-700 font-semibold">{{ __('ユーザー分析') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path
                  d="M21.9998 12.86C21.9998 15.15 20.8198 17.1801 18.9998 18.4601L17.6598 21.41C17.3498 22.08 16.4498 22.2101 15.9798 21.6401L14.4998 19.86C12.0798 19.86 9.91982 18.7901 8.56982 17.1201L9.49982 16.0001C13.6398 16.0001 16.9998 12.8701 16.9998 9.00006C16.9998 7.95006 16.7498 6.96007 16.2998 6.07007C19.5698 6.82007 21.9998 9.58005 21.9998 12.86Z"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7 9H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>

              <a href="#" class="text-gray-700 font-semibold">{{ __('コメント管理') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
                <path d="M16.5 9.5L12.3 13.7L10.7 11.3L7.5 14.5" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14.5 9.5H16.5V11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <a href="#" class="text-gray-700 font-semibold">{{ __('トレンド分析') }}</a>
            </li>
            <li class="mb-6 flex items-center hover:text-primary dark:hover:text-f5 hover:cursor-pointer">
              <svg class="h-5 w-5 mr-5" viewBox="0 0 24 24" fill="none">
                <path
              ...
              <a href="#" class="text-gray-700 font-semibold">{{ __('ランキング') }}</a>
            </li>
    ...
    {{-- <div class="w-full flex flex-col md:flex-row justify-around mx-auto px-8 lg:pt-4 lg:pb-8 lg:px-8 mb-8">
