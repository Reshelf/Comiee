...
<label class="acd-label inline-block" for="acd-check1">
    <div
        class="inline-flex hover:text-primary dark:hover:text-ddd stroke-666 hover:stroke-primary dark:stroke-ddd items-center text-xs rounded-[3px] px-2 py-1.5 font-semibold cursor-pointer">
