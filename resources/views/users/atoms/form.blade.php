...
<div class="relative flex items-center mb-4">
  <h3 class="tracking-widest text-[15px] font-semibold">{{ __('カバー画像') }}</h3>
...
<div class="relative flex items-center mt-12 mb-4">
  <h3 class="tracking-widest text-[15px] font-semibold">{{ __('プロフィール画像') }}</h3>
  <div class="tooltip cursor-pointer ml-1">
    <svg class="stroke-primary w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke-width="1.5">
      <path stroke-linecap="round" stroke-linejoin="round"
        d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
...
{{-- 名前 --}}
<h3 class="tracking-widest mt-12 mb-4 text-[15px] font-semibold">{{ __('名前') }}</h3>
<div class="mb-12">
