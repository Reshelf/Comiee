...
<table role="presentation" style="width: 100%; background:#F5F8FA;">
    <tr>
        <td align="left" style="padding: 30px 30px;">
            <p style="color:#99ACC2"> &copy; Starbooks {{ \Carbon\Carbon::now()->format('Y') }}</p>
            <a style="font-size: 9px;text-transform:uppercase;letter-spacing: 1px;color: #99ACC2;" href="#">
                メール配信設定はこちらから
            </a>
        </td>
    </tr>
