                                  ...
                                  <table border="0" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <a href="{{ config('app.stripe_url') }}"
                                            ...
                                            <svg height="32" viewBox="0 0 382 301" fill="none">
                                              ...
                                              <g mask="url(#mask0_793_3558)">
                                                <mask id="mask1_793_3558" style="mask-type:alpha"
                                                  maskUnits="userSpaceOnUse" x="-6" y="-6"
                                                  width="392" height="392">
                                                  <rect x="-5.20898" y="-5.20801" width="390.614" height="390.614"
                                                    fill="white" />
                                                </mask>
                                                <g mask="url(#mask1_793_3558)">
                                                  <path
                                                    ...
                                                    fill="#EC3B73" />
                                                  <path d="M209.628 284.892L321.261 384.499H97.9953L209.628 284.892Z"
                                                    fill="#C13573" />
                                                  <path
                                        ...
                                        <td width="100%"><a href=""
                                            style="color:#1877f2;text-decoration:none;font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:19px;line-height:32px"
                                            target="_blank"></a>
                                        </td>
                                      </tr>
