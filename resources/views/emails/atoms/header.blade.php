<tr>
    <td align="left" style="padding:20px;background:#fff;border-bottom:1px solid #ddd;">
        <a href="{{ config('app.stripe_url') }}">
            <svg height="32" viewBox="0 0 382 301" fill="none">
                ...
                <g mask="url(#mask0_793_3558)">
                    <mask id="mask1_793_3558" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-6"
                        y="-6" width="392" height="392">
