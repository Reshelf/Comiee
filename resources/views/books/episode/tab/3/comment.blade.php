                ...
                <div class="flex items-center">
                    ...
                    <comment-post-modal class="mr-4">
                        ...
                        <form method="POST"
                            ...
                            <textarea class="w-full h-[250px] rounded-[3px] dark:bg-dark-1"
            ...
            @if ($comment->user->id != Auth::id())
                <comment-post-modal>
                    ...
                    <form method="POST"
                        ...
                        @csrf
                        <input value="{{ Auth::id() }}" type="hidden" name="user_id" />
                        <textarea class="dark:bg-dark-1 w-full h-[250px] rounded-[3px] dark:bg-dark-1" placeholder="お問い合せ内容を記入してください。"
