<template>
  <div class="max-w-4xl m-8 md:my-16 md:mx-auto leading-8">
    <h2 class="text-2xl lg:text-3xl">{{ t('利用規約') }}</h2>
    ...
    <h3 class="text-xl lg:text-2xl my-4">2条 規約への同意</h3>
    <div class="mb-10 mt-4 text-[16px]">
    ...
    <h3 class="text-xl lg:text-2xl my-4">3条 本利用規約の更新</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1.
    ...
    <h3 class="text-xl lg:text-2xl my-4">4条 会員登録</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1.
    ...
    <h3 class="text-xl lg:text-2xl my-4">5条 メールアドレスとパスワード</h3>
    <div class="mb-10 mt-4 text-[16px]">
    ...
    <h3 class="text-xl lg:text-2xl my-4">6条 取引契約</h3>
    <div class="mb-10 mt-4 text-[16px]">
    ...
    <h3 class="text-xl lg:text-2xl my-4">7条 退会</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1. 会員ユーザーは、所定の方法で当運営に通知することにより、退会（自己の会員ユーザーとしての登録を抹消すること）ができるものとします。</p>
    </div>

    <h3 class="text-xl lg:text-2xl my-4">8条 プライバシー</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1.
    ...
    <h3 class="text-xl lg:text-2xl my-4">9条 禁止事項</h3>
    <div class="mb-10 mt-4 text-[16px]">
    ...
    <h3 class="text-xl lg:text-2xl my-4">10条 違反に対する処理</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1.
    ...
    <h3 class="text-xl lg:text-2xl my-4">11条 免責事項</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1. 当運営は、
    ...
    <h2 class="text-xl lg:text-2xl">Comieeクリエイター規約</h2>

    <h3 class="text-xl lg:text-2xl  my-4">1条 販売価格</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">
    ...
    <h3 id="sales_and_author_profit" class="text-xl lg:text-2xl my-4">2条 売上とクリエイター利益</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">
    ...
    <h3 id="" class="text-xl lg:text-2xl my-4">3条 配信に関するComieeの権利</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">
      <p class="">配信範囲</p>
    ...
    <h3 class="text-xl lg:text-2xl  my-4">3条 禁止事項</h3>
    <div class="mb-10 mt-4 text-[16px]">
    ...
    <h3 class="text-xl lg:text-2xl  my-4">4条 違反に対する処理</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">
    ...
    <h3 class="text-xl lg:text-2xl  my-4">5条 違約金</h3>
    <div class="mb-10 mt-4 text-[16px]">
      <p class="my-2">1.
    ...
    <h3 id="refund" class="text-xl lg:text-2xl my-4">4条 返金</h3>
    <div class="mb-10 mt-4 text-[16px]">
