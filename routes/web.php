...
Route::prefix('b')->name('book.')->group(function () {
    ...
    Route::put('/{book_id}/{episode_id}/like', 'App\Http\Controllers\Books\Episode\LikeController')->name('episode.like');
    Route::delete('/{book_id}/{episode_id}/like', 'App\Http\Controllers\Books\Episode\UnlikeController')->name('episode.unlike');
